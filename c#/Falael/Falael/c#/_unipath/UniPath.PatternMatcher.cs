...
internal static class PatternMatcher
{
	...
	///
	///
	public static bool StrictMatchPattern(string expression, string name, StringComparison stringComparison)
	{
		int nameOffset;
		int exprOffset;
		int length;
		...
		while (!nameFinished)
		{
			...
			while (srcCount < matchesCount)
			{
				...
				while (true)
				{
					...
					//
					if (string.Equals(exprChar.ToString(), nameChar.ToString(), stringComparison))
					{
						currentMatches[destCount++] = currentState;
						break;
					}
